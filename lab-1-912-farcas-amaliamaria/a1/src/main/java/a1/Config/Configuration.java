...
public class Configuration {
    ...
    CommandLineRunner commandLineRunner(AnimalRepository animalRepository, ShelterRepository shelterRepository, MedicalRecordRepository medicalRecordRepository, VolunteerRepository volunteerRepository, VolunteerAnimalRepository volunteerAnimalRepository){
        return args -> {
            ...
            Shelter oradea = new Shelter("OradeaAnimals", "Oradea", 658458L, 40388968519L, 300);
            Shelter zalau = new Shelter("ZalauAnimals", "Zalau", 112244L, 40388968511L, 50);
            Shelter timisoara = new Shelter("TimisoaraAnimals", "Timisoara", 112233L, 40399968592L, 370);
            Shelter bucuresti = new Shelter("BucurestiAnimals", "Bucuresti", 658450L, 40388558593L, 450);
            Shelter pitesti = new Shelter("PitestiAnimals", "Pitesti", 651458L, 40380968594L, 200);
            Shelter satuMare = new Shelter("SatuMareAnimals", "SatuMare", 658478L, 40388111575L, 100);
            Shelter sibiu = new Shelter("SibiuAnimals", "Sibiu", 158458L, 40388911199L, 120);
            Shelter brasov = new Shelter("BrasovAnimals", "Brasov", 602458L, 40388900199L, 400);
            Shelter iasi = new Shelter("IasiAnimals", "Iasi", 651018L, 40388101799L, 90);
